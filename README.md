...
# 学习emacs 有哪些经验？
	...
	发现玩的成分多一些，就像照相馆里的ps，打印社的office，一个软件的精通 vs 多个软件的了解?
	
	很长时间，一直在用，但是好像没有什么是必须的，不可替代的？
	
	能用，而且基本都知道些，但是就是感觉没有用起来？比如，用emacs写本书？写文章？
	

## Timestamp (M-x gnu-insert-timestamp)
Last Modified: 2022-01-04 18:57:05 +0800
